                        ...
                        <nav class="navbar navbar-expand-md  default top-nav-collapse">
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('marketplace.home')}}">{{__('Directory')}}</a>
                                    </li>
                        ...
                        <div class="row g-0 gy-2 mt-4 align-items-center">
                            ...
                            <div class="col-xxl-9">
                                <div class="row gy-3 row-cols-9">
                                    {{-- <div class="col-auto">
                                        <img src="{{ $logo . '/' . $settings['home_logo'] }}" alt=""
                                            style="width: 130px;" class="img-fluid">
                                    </div>
                                    <div class="col-auto">
                                        <img src="{{ $logo . '/' . $settings['home_logo'] }}" alt=""
                                            style="width: 130px;" class="img-fluid">
                                            ...
                                            <ul class="list-unstyled my-3">
                                                ...
                                                <li>
                                                    <div class="form-check text-start">
                                                        {{-- <input class="form-check-input input-primary" type="checkbox"
                                                            id="customCheckc1"
                                                            {{ $value->max_account != 0 ? 'checked' : '' }}> --}}
                                                        <label class="form-check-label" for="customCheckc1">
                                                            @if ($value->max_account == '-1')
                                                                Unlimited Account
                                                            @else
                                                                {{ $value->max_account }} Account
                                                            @endif
                                                        </label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check text-start">
                                                        {{-- <input class="form-check-input input-primary" type="checkbox"
                                                            id="customCheckc1"
                                                            {{ $value->max_contact != 0 ? 'checked' : '' }}> --}}
                                                        <label class="form-check-label" for="customCheckc1">
                                                            @if ($value->max_contact == '-1')
                                                                Unlimited Contact
                                                            @else
                                                                {{ $value->max_contact }} Contact
                                                            @endif
                                                        </label>
                                                    </div>
                                                </li>
