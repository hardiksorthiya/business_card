...
use Modules\LandingPage\Http\Controllers\HomeController as LandingPageHomeController;
...
Route::prefix('landing-page')->group(function(){
    Route::group(
        ...
        function () {
        Route::get('landing-page/home', 'LandingPageController@index')->name('landingpage.home');
    ...
    Route::resource('homesection', LandingPageHomeController::class);
...
Route::get('directory/home', 'MarketplaceController@index')->name('marketplace.home');
Route::get('directory/search', [MarketplaceController::class, 'search'])->name('business.search');
Route::get('/', [MarketplaceController::class, 'landingHome'])->name('landingpage.backhome');
