...
@if ($business->status != 'lock')
    <div class="d-flex align-items-center  gap-2 header-info-btn-wrapper">
        ...
        <a href="#"
                class="btn btn-sm btn-success cp_link"
            ...
            <div class="page-block">
                <div class="row gy-4 align-items-center">
                    <div class="col-md-4">
                        ...
                        <ul class="list-unstyled business-list business-header">
                    ...
                    <div class="col-md-8">
                        <ul class="nav nav-pills nav-fill information-tab" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link @if(session('tab') and session('tab') == 9) active @endif" id="payment-setting-tab" data-bs-toggle="pill"
                ...
                <div class="row">
                     <div class="col-lg-12">
                        <div class="tab-content" id="pills-tabContent">
                                                        ...
                                                        {{-- <form action=""> --}}
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-6">
                                                                    ...
                                                                    {!! Form::select('category', $category, $business->business_category, ['class' => 'form-control select2 ', 'required' => 'required']) !!}
                                                                    @error('category')
                                                                ...
                                                                <div id="collapseseven"
                                                                    ...
                                                                    <div class="accordion-body">
                                                                        <div class="form-group google_map_link">
                                                                            ...
                                                                            <textarea class="form-control" name="google_map_link" cols="10" rows="3" id="{{ $stringid }}_map_link" >{{ isset($business['google_map_link']) && $business['google_map_link'] ? $business['google_map_link'] : '' }}</textarea>
                                                                        ...
                                                                        <div class="app_info_block">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="playstore_id" id="{{ $stringid }}_playstore_id" value="{{ isset($appInfo['playstore_id']) && $appInfo['playstore_id'] ? $appInfo['playstore_id'] : '' }}">
                                                                                </div>
                                                                                @error('playstore_id')
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="appstore_id" id="{{ $stringid }}_appstore_id" value="{{ isset($appInfo['appstore_id']) && $appInfo['appstore_id'] ? $appInfo['appstore_id'] : '' }}"/>
                                                                                </div>
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group" >
                                                                ...
                                                                {{ Form::text('cookie_title', !empty($cookieDetail->cookie_title)?$cookieDetail->cookie_title: 'We use cookies!', ['class' => 'form-control cookie_setting'] ) }}
                                                            </div>
                                                            <div class="form-group ">
                                                                {{ Form::label('cookie_description', __('Cookie Description'), ['class' => ' form-label']) }}
                                                                {!! Form::textarea('cookie_description', !empty($cookieDetail->cookie_description)?$cookieDetail->cookie_description:'Hi, this website uses essential cookies to ensure its proper operation and tracking cookies to understand how you interact with it', ['class' => 'form-control cookie_setting', 'rows' => '3']) !!}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check form-switch custom-switch-v1 ">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                {{ Form::text('strictly_cookie_title', !empty($cookieDetail->strictly_cookie_title)?$cookieDetail->strictly_cookie_title:'Strictly necessary cookies', ['class' => 'form-control cookie_setting']) }}
                                                            </div>
                                                            <div class="form-group ">
                                                                {{ Form::label('strictly_cookie_description', __('Strictly Cookie Description'), ['class' => ' form-label']) }}
                                                                {!! Form::textarea('strictly_cookie_description', !empty($cookieDetail->strictly_cookie_description)?$cookieDetail->strictly_cookie_description:'These cookies are essential for the proper functioning of my website. Without these cookies, the website would not work properly', ['class' => 'form-control cookie_setting ', 'rows' => '3']) !!}
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                ...
                                                                {{ Form::text('more_information_description', !empty($cookieDetail->more_information_description)?$cookieDetail->more_information_description:'For any queries in relation to our policy on cookies and your choices,', ['class' => 'form-control cookie_setting']) }}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                {{ Form::label('contactus_url', __('Contact Us URL'), ['class' => 'col-form-label']) }}
                                                                {{ Form::text('contactus_url', !empty($cookieDetail->contactus_url)?$cookieDetail->contactus_url:'#', ['class' => 'form-control cookie_setting']) }}
                                                            </div>
                                                        </div>
                            ...
                            {{-- End Custom QR-Code  --}}
                            {{-- Payment Setting --}}
                            <div class="tab-pane fade @if(session('tab') and session('tab') == 9) show active @endif" id="payment-setting" role="tabpanel" aria-labelledby="pills-user-tab-8">
                                <div class="row gy-4">
                                    <div class="col-lg-12 col-md-12">
                                        {{ Form::open(['route' => ['business.payment_setting', $business->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                            <div class="theme-detail-card">
                                                <div class="mb-4 d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-check form-switch custom-switch-v1">
                                                            <input type="checkbox"
                                                                class="form-check-input input-primary"
                                                                name="enable_payment" id="enable_payment" {{ isset($cardPayment->is_enabled) && $cardPayment->is_enabled == 1 ? 'checked="checked"' : '' }}>
                                                            <label class="form-check-label"
                                                                for="customswitchv2-2"></label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <div class="card sticky-top payment-card-left" style="top:30px">
                                                        <div class="row">
                                                                <div class="form-group">
                                                                    {{ Form::label('payment_amount', __('Payment Amount'), ['class' => 'form-label']) }}
                                                                    {{ Form::text('payment_amount', $cardPayment ? $cardPayment->payment_amount : '', ['class' => 'form-control']) }}
                                                        ...
                                                        <div class="accordion accordion-flush card  setting-accordion" id="accordionExample">
                                                            ...
                                                            <div class="accordion-item card">
                                                                ...
                                                                <div id="collapseFour" class="accordion-collapse collapse"
                                                                    ...
                                                                    <div class="accordion-body">
                                                                        <div class="program-data-div {{ isset($cardPayment_content->paypal) && is_object($cardPayment_content->paypal) && $cardPayment_content->paypal->status === 'on' ? 'active' : '' }}" id="paypalContainer">
                                                                            <div class="row">
