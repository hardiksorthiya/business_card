...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('custom/theme1/fonts/stylesheet.css') }}">

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('custom/theme1/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme1/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('custom/theme1/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme1/css/responsive.css') }}">
    @endif
...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme1'][$business->theme_color]['theme_name'] }}"
        id="view_theme11">
        <main id="boxes">
                        ...
                        @foreach ($card_theme->order as $order_key => $order_value)
                            @if ($j == $order_value)
                                                        ...
                                                        @if ($key1 != 'id')
                                                            <li id="contact_{{ $loop->parent->index + 1 }}">
                                                                @if ($key1 == 'Address')
                                                                    ...
                                                                    @endforeach
                                                                    <span class="icon">
                                                                        <img src="{{ asset('custom/theme1/icon/' . $color . '/' . strtolower($key1) . '.svg') }}"
                                                                            class="img-fluid">
                                                                    </span>
                                                    ...
                                                    <div class="service-card-inner">
                                                        ...
                                                        @if (!empty($content->purchase_link))
                                                            <a href="{{ url($content->purchase_link) }}"
                                                                ...
                                                                class="btn-secondary">{{ $content->link_title }} <svg
                                ...
                                @if ($order_key == 'product')
                                    <section class="service-section" id="product-div">
                                        <div class="section-title text-center">
                                            <h2>{{ __('Product') }}</h2>
                                        </div>
                                        ...
                                        <ul class="btn-list">
                                            ...
                                            <li>
                                                <a href="javascript:void(0)"
                                                    class="btn share-modal-toggle">{{ __('Share Card') }}<svg
                                            ...
                                            <li>
                                                <a href="javascript:void(0)"
                                                    class="btn make-contact-modal-toggle">{{ __('Contact') }}<svg
                                                        xmlns="http://www.w3.org/2000/svg" width="33"
                                                        height="32" viewBox="0 0 33 32" fill="none">
                                                        <path opacity="0.4"
                                        ...
                                        <div class="greetings-desk">
                                            <div class="user-text-avatar">
                                                <img src="{{ isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/img/logo-placeholder-image-2.png') }}"
                                                    alt="">
                                                <div class="up-text" id="{{ $stringid . '_chtml' }}_preview">
                                                    {!! stripslashes($custom_html) !!}</div>
                                            </div>
                                        </div>
                                    </section>
                                @endif
    ...
    <script src="{{ asset('custom/theme1/js/jquery.min.js') }}"></script>
    <script src="{{ asset('custom/theme1/js/slick.min.js') }}" defer="defer"></script>
    @if ($SITE_RTL == 'on')
        <script src="{{ asset('custom/theme1/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('custom/theme1/js/custom.js') }}" defer="defer"></script>
    @endif
