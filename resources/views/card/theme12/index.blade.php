...
<body class="tech-card-body">
    ...
    <div class="{{ \App\Models\Utility::themeOne()['theme12'][$business->theme_color]['theme_name'] }}" id="view_css">
                    ...
                    @if ($j == $order_value)
                        ...
                        @if ($order_key == 'payment')
                            <section class="card-payment-section" id="payment-section">
                                <div class="title-svg">
                                    <img src="{{ asset('custom/theme12/icon/' . $color . '/credit-card.svg') }}"
                                        alt="user" class="img-fluid">
                                </div>
                        ...
                        @if ($order_key == 'appinfo')
                            <section class="card-payment-section" id="app-section">
                                <div class="title-svg">
                                    <img src="{{ asset('custom/theme12/icon/' . $color . '/mobile-app.svg') }}"
                                        alt="user" class="img-fluid">
                                </div>
                                <div class="section-title text-center">
                    ...
                    <div class="share-card-wrapper">
                        ...
                        <div class="qr-scaner-wrapper">
                            ...
                            <ul class="card-social-icons">
                                ...
                                <li><a
                                        href="https://www.linkedin.com/shareArticle?url={{ urlencode($url_link) }}&title="><img
