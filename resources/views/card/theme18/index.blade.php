 @php
     ...
     if (!is_null($custom_html) && !is_null($customhtml)) {
         $customhtml->is_custom_html_enabled == '1'
             ? ($is_custom_html_enable = true)
             : ($is_custom_html_enable = false);
     }
                 ...
                 @foreach ($card_theme->order as $order_key => $order_value)
                     @if ($j == $order_value)
                         ...
                         @if ($order_key == 'product')
                             <section class="product-section box-shadow padding-top padding-bottom" id="product-div">
                                 <div class="container">
                                     <div class="section-title text-center">
                                         <h2>{{ __('Product') }}</h2>
                                     </div>
                             ...
                             <div class="col-12">
                                 <div class="form-group">
                                     ...
                                     <input type="password" name="Password"
                                         placeholder="{{ __('Enter password') }}" class="form-control password_val"
