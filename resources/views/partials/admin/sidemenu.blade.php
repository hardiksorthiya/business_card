...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            @else
                <li class="dash-item {{ Request::segment(1) == 'users' ? 'active open' : '' }}">
                    <a href="{{ route('users.index') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-users"></i></span><span
                            class="dash-mtext">{{ __('Companies') }}</span></a>
                ...
                <li class="dash-item dash-hasmenu">
                    <a class="dash-link {{ Request::segment(1) == 'employee' || Request::segment(1) == 'client' ? 'active' : '' }}"
                        ...
                        aria-controls="navbar-getting-started"><span class="dash-micon"><i
                            ...
                            class="dash-mtext">{{ __('Qr Code') }}</span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span>
                    </a>
                    <ul class="dash-submenu">
                        @foreach ($menus as $module)
                            @if (\App\Models\Utility::module_is_active($module['module']))
                                <li class="dash-item dash-hasmenu">
                                    <a class="dash-link"
            ...
            @if (Auth::user()->type == 'super admin')
                <li class="dash-item {{ Request::segment(1) == 'add-on' ? 'active' : '' }}">
                    <a href="{{ route('module.index') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-layout-2"></i></span><span
                            class="dash-mtext">{{ __('Add-on Manager') }}</span></a>

                </li>
            @endif
            @if (Auth::user()->type == 'super admin')
                <li class="dash-item {{ Request::segment(1) == 'business-category' ? 'active' : '' }}">
                    <a href="{{ route('category.index') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-package"></i></span><span
                            class="dash-mtext">{{ __('Marketplace') }}</span></a>
