                        ...
                        <nav class="navbar navbar-expand-md  default top-nav-collapse">
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo e(route('marketplace.home')); ?>"><?php echo e(__('Directory')); ?></a>
                                    </li>
                                            ...
                                            <ul class="list-unstyled my-3">
                                                <li>
                                                    <div class="form-check text-start">
                                                        ...
                                                        <label class="form-check-label" for="customCheckc1">
                                                            <?php if($value->max_user == '-1'): ?>
                                                                Unlimited User
                                                            <?php else: ?>
                                                                <?php echo e($value->max_user); ?> User
                                                            <?php endif; ?>
                                                        </label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check text-start">
                                                        ...
                                                        <label class="form-check-label" for="customCheckc1">
                                                            <?php if($value->max_account == '-1'): ?>
                                                                Unlimited Account
                                                            <?php else: ?>
                                                                <?php echo e($value->max_account); ?> Account
                                                            <?php endif; ?>
                                                        </label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check text-start">
                                                        ...
                                                        <label class="form-check-label" for="customCheckc1">
                                                            <?php if($value->max_contact == '-1'): ?>
                                                                Unlimited Contact
                                                            <?php else: ?>
                                                                <?php echo e($value->max_contact); ?> Contact
                                                            <?php endif; ?>
                                                        </label>
                                                    </div>
                                                </li>
                                                    ...
                                                    <div class="form-check text-start">
                                                        ...
                                                        <label class="form-check-label" for="customCheckc1">
                                                            <?php if($value->storage_limit == '-1'): ?>
                                                                Unlimited Storage
                                                            <?php else: ?>
                                                                <?php echo e($value->storage_limit); ?> Storage
                                                            <?php endif; ?>
                                                        </label>
                                                    </div>
                                                </li>
...
<?php /**PATH C:\xampp\8.2.0\htdocs\business_card\main-file\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>