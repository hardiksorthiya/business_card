            ...
            <div class="row">
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                     ...
                     border-0"><?php echo e(__('Site Settings')); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action">
                                                <div class="action-btn bg-info  ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-toggle="modal" data-target="#commonModal" data-ajax-popup="true" data-size="md" data-url="<?php echo e(route('webhook.edit',$webhook_detail->id)); ?>" data-title="<?php echo e(__('Webhook Edit')); ?>" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Webhook Edit')); ?>"> <span class="text-white"><i
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\8.2.0\htdocs\business_card\main-file\resources\views/settings/index.blade.php ENDPATH**/ ?>