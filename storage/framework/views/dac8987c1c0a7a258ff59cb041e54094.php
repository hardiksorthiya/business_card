                        ...
                        <div class="card-header border-0 pb-0">
                            <div class="d-flex align-items-center">
                                <div class="row">
                                    ...
                                    <span><?php echo e(!empty($admin_payment_setting['CURRENCY_SYMBOL']) ? $admin_payment_setting['CURRENCY_SYMBOL'] : '$'); ?><?php echo e($nfcCard->price); ?></span>
                                </div>
                            </div>
            ...
            <?php $__currentLoopData = $nfcCardData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $nfcCard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 my-3">
                    <div class=" nfc-card-image1 border mx-auto box-shadow">
                        ...
                        <?php if($headers && strpos($headers[0], '200')): ?>
                            <img class="image"
                                src="<?php echo e(isset($nfcCard->image) && !empty($nfcCard->image) ? $nfcImage . '/' . $nfcCard->image : asset('custom/img/logo-placeholder-image-21.png')); ?>"
                                alt="">
                        <?php else: ?>
                            <img class="image" src="<?php echo e(asset('custom/nfcimg/nfc' . $key + 1 . '.png')); ?>" alt="">
                        <?php endif; ?>
                        <div class="info">
                            <div class="header">
                                <div class="title-info">
                                    <a data-url="<?php echo e(route('nfc.order', $nfcCard->id)); ?>" data-size="md" class="text-end"
                                        data-ajax-popup="true" class="dropdown-item"
                                        data-bs-whatever="<?php echo e(__('Order NFC Card')); ?>" data-bs-toggle="tooltip"
                                        data-title="<?php echo e(__('Order NFC Card')); ?>"><span class="price">
                                ...
                                <p class="id m-0">
                                    <?php echo e(!empty($admin_payment_setting['CURRENCY_SYMBOL']) ? $admin_payment_setting['CURRENCY_SYMBOL'] : '$'); ?><?php echo e($nfcCard->price); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\8.2.0\htdocs\business_card\main-file\resources\views/nfc/index.blade.php ENDPATH**/ ?>