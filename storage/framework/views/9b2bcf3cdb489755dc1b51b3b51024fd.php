...
<body class="<?php echo e($themeColor); ?>">
    ...
    <footer class="dash-footer">
        <div class="footer-wrapper">
            <div class="py-1">
                <p class="">
                    &copy;&nbsp;<?php echo e(date('Y')); ?>&nbsp;<?php echo e(isset($langSetting['footer_text']) ? $langSetting['footer_text'] : config('app.name', 'vCardGo-SaaS')); ?></p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\xampp\8.2.0\htdocs\business_card\main-file\resources\views/layouts/admin.blade.php ENDPATH**/ ?>